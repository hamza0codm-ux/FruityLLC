...
const configuredTables = {
    ...
    // Fruity Garden
    fruit_gardens: 'fruit_gardens',
    fruit_garden_inventory: 'fruit_garden_inventory',
};
...
export function resolvePostgresPoolConfig() {
    ...
    const sharedOptions = {
        ...
        idleTimeoutMillis:
            parseInt(process.env.POSTGRES_IDLE_TIMEOUT) || 30000,
        connectionTimeoutMillis:
            parseInt(process.env.POSTGRES_CONNECTION_TIMEOUT) || 10000,

        application_name: 'titanbot',

        statement_timeout:
            process.env.NODE_ENV === 'production' ? 30000 : 0,
...
export const pgConfig = {
    ...
    options: {
        ...
        backoffBase:
            parseInt(process.env.POSTGRES_BACKOFF_BASE) || 100,
        backoffMultiplier:
            parseInt(process.env.POSTGRES_BACKOFF_MULTIPLIER) || 2,
    },
